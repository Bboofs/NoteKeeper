...
public class NoteListActivityTest {
    ...
    public void noteListActivityTest() {
        ...
        ViewInteraction appCompatEditText2 = onView(
                allOf(withId(R.id.text_note_title), withText("te"),
                        childAtPosition(
                                childAtPosition(
                                        withClassName(is("androidx.coordinatorlayout.widget.CoordinatorLayout")),
                                        1),
        ...
        ViewInteraction appCompatEditText4 = onView(
                allOf(withId(R.id.text_note_title), withText("test "),
                        childAtPosition(
                                childAtPosition(
                                        withClassName(is("androidx.coordinatorlayout.widget.CoordinatorLayout")),
                                        1),
        ...
        ViewInteraction appCompatEditText5 = onView(
                allOf(withId(R.id.text_note_text),
                        childAtPosition(
                                ...
                                2),
                        isDisplayed()));
        appCompatEditText5.perform(replaceText("no te"), closeSoftKeyboard());
