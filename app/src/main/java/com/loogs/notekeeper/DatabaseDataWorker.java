...
public class DatabaseDataWorker {
    ...
    public void insertSampleNotes() {
        ...
        insertNote(null, "Service default threads", "Did you know that by default an Android Service will tie up the UI thread?");
    ...
    private void insertCourse(String courseId, String title) {
     ...
     private void insertNote(String courseId, String title, String text) {
        ...
        //long newRowId = mDb.insert(NoteKeeperDatabaseContract.NoteInfoEntry.TABLE_NAME, null, values);
         ...
         try {
             long newRowId = mDb.insertOrThrow(NoteKeeperDatabaseContract.NoteInfoEntry.TABLE_NAME, null, values);
             //mDb.insertOrThrow(NoteKeeperDatabaseContract.NoteInfoEntry.TABLE_NAME, null, values);
             Log.d("INSERT OK", "successful");
         }
         catch(SQLiteException exception) {
             Log.d("INSERT ERROR", exception.getMessage());
